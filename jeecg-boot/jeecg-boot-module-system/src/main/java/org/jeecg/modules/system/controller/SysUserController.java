...
@Api(value = "用户表", protocols = "JSON", tags = "用户表")
public class SysUserController {
    ...
    @ApiOperation(value = "根据 id 查询", notes = "根据 id 查询")
     ...
     * @return
     */
    @ApiOperation(value = "校验用户账户是否唯一", notes = "校验用户账户是否唯一")
     ...
     * @return
     */
    @ApiOperation(value = "生成在添加用户情况下没有主键的问题,返回给前端,根据该id绑定部门数据", notes = "生成在添加用户情况下没有主键的问题,返回给前端,根据该id绑定部门数据")
     ...
     * @return
     */
    @ApiOperation(value = "查询所有用户所对应的角色信息", notes = "查询所有用户所对应的角色信息")
     ...
     */
    @ApiOperation(value = "根据 orgCode 查询用户，包括子部门下的用户", notes = "若某个用户包含多个部门，则会显示多条记录，可自行处理成单条记录")
     ...
     */
    @ApiOperation(value = "根据 orgCode 查询用户，包括子部门下的用户", notes = "针对通讯录模块做的接口，将多个部门的用户合并成一条记录，并转成对前端友好的格式")
     ...
     * 给指定部门添加对应的用户
     */
    @ApiOperation(value = "给指定部门添加对应的用户", notes = "给指定部门添加对应的用户")
     ...
     * 删除指定机构的用户关系
     */
    @ApiOperation(value = "删除指定机构的用户关系", notes = "删除指定机构的用户关系")
     ...
     * 批量删除指定机构的用户关系
     */
    @ApiOperation(value = "批量删除指定机构的用户关系", notes = "批量删除指定机构的用户关系")
     ...
     * @return
     */
    @ApiOperation(value = "根据用户名或手机号查询用户信息", notes = "根据用户名或手机号查询用户信息")
     ...
     * @return
     */
    @ApiOperation(value = "根据TOKEN获取用户的部分信息（返回的数据是可供表单设计器使用的数据）", notes = "根据TOKEN获取用户的部分信息（返回的数据是可供表单设计器使用的数据）")
    ...
    @ApiOperation(value = "获取用户列表-根据用户名和真实名，模糊匹配", notes = "获取用户列表-根据用户名和真实名，模糊匹配")
